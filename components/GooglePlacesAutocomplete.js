...
const defaultStyles = {
  ...
  textInputContainer: {
    backgroundColor: 'white', // '#C9C9CE',
    height: 44,
    borderTopColor: '#7e7e7e',
    borderBottomColor: '#b5b5b5',
    borderTopWidth: 0, // 1 / PixelRatio.get(),
...
export default class GooglePlacesAutocomplete extends Component {
  ...
  setAddressText = address => this._safeSetState({ text: address })
  ...
  _onPress = (rowData) => {
    if (rowData.isPredefinedPlace !== true && this.props.fetchDetails === true) {
      ...
      request.onreadystatechange = () => {
        ...
        console.log('GoogleGeoloc::request::onreadystatechange', request);
  ...
  _onFocus = () => this._safeSetState({ listViewDisplayed: true })
    ...
    return (
      ...
      >
        <Image
          ...
          resizeMode='contain'
          source={require('../assets/graphics/powered_by_google_on_white.png')}
        />
      </View>
    );
  }
